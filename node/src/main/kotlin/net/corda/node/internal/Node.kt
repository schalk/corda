 ...
 * @param networkMapService An external network map service to use. Should only ever be null when creating the first
...
class Node(override val configuration: FullNodeConfiguration,
    ...
    override val networkMapAddress: NetworkMapAddress? get() = networkMapService?.address
    ...
    override fun makeMessagingService(): MessagingServiceInternal {
        ...
        val myIdentityOrNullIfNetworkMapService = if (networkMapService != null) obtainLegalIdentity().owningKey else null
